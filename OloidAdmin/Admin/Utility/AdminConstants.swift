...
struct AdminConstants {
    ...
    struct AdminUrlConstants {
        
        static let kLoginUrl = "https://v2abf3htv3.execute-api.us-east-2.amazonaws.com/dev/login"
        ...
        static let KListApplicationUsersUrl = "https://v2abf3htv3.execute-api.us-east-2.amazonaws.com/dev/applications"
    }
}
